    ...
    <div className={styles.aboutSection}>
      <div className={styles.container}>
        <div className={styles.leftColumn}>
          <h2 className={styles.title}>Learn About Bansal Truck Insurance Agency</h2>
        ...
        <div className={styles.rightColumn}>
          <div className={styles.description}>
            ...
            <p>
              You get more than just insurance coverage at Bansal Truck Insurance Agency. We are an independent insurance agency, which means you get the power of choice. By working with several top-rated insurance carriers, we can offer you a variety of options when it comes to your protection. Coupled with our knowledgeable and dedicated customer service, were here for you so you can stay focused on the road ahead.
            </p>
          </div>
